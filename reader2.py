...
class Reader():
    ...
    def op_test(self):
        """選擇測驗篇"""
        put_button(label='人物篇', onclick=self.a)
        put_button(label='辦公室篇', onclick=self.b)
        put_button(label='人事管理篇', onclick=self.c)
        put_button(label='薪資金錢篇', onclick=self.d)
        put_button(label='業務篇', onclick=self.e)
        put_button(label='財務篇', onclick=self.f)
        put_button(label='貿易篇', onclick=self.g)
        put_button(label='會議篇', onclick=self.h)
